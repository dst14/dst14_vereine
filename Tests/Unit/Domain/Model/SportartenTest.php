 ...
 */
class SportartenTest extends \TYPO3\CMS\Extbase\Tests\Unit\BaseTestCase {
	/**
	...
	public function setFachbereichForStringSetsFachbereich() { 
		$this->fixture->setFachbereich('Conceived at T3CON10');

		$this->assertSame(
			'Conceived at T3CON10',
			$this->fixture->getFachbereich()
		);
	}
	...
	public function setFbwebForStringSetsFbweb() { 
		$this->fixture->setFbweb('Conceived at T3CON10');

		$this->assertSame(
			'Conceived at T3CON10',
			$this->fixture->getFbweb()
		);
	}

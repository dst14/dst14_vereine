	...
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table_where' => 'AND tx_dst14vereine_domain_model_landesverbaende.pid=###CURRENT_PID### AND tx_dst14vereine_domain_model_landesverbaende.sys_language_uid IN (-1,0)',
			),
		),
		...
		'lvweb' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:dst14_vereine/Resources/Private/Language/locallang_db.xlf:tx_dst14vereine_domain_model_landesverbaende.lvweb',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'trim'
